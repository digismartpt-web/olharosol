export const restaurantConfig = {
  ...
  aboutText: [
    "Situado em Riba d'Ave, o Olhar o Sol é a referência gastronómica de excelência na região.",
    "Num ambiente acolhedor e autêntico, a nossa equipa de profissionais dedicados elabora cada prato com ingredientes frescos criteriosamente selecionados. Conjugamos tradição artesanal e paixão pelo sabor para criar momentos inesquecíveis.",
    "Descubra a experiência culinária que nos tornou referência. Venha partilhar a nossa paixão pela gastronomia de qualidade."
  ],
  address: {
